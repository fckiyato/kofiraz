...
(function ($) {
    ...
    $(function () {
        $(".price-range").slider({
            ...
            max: 10000,
            values: [1500, 5000],
            slide: function (event, ui) { $(".priceRange").val("تومان" + ui.values[0].toLocaleString() + " - تومان" + ui.values[1].toLocaleString()); }
        });
        $(".priceRange").val("تومان" + $(".price-range").slider("values", 0).toLocaleString() + " - تومان" + $(".price-range").slider("values", 1).toLocaleString());
    });
    ...
    $(".journey-day-name").html(journeyDate.toLocaleString('fa', { weekday: 'long' }));
    $(".return-day-name").html(returnDate.toLocaleString('fa', { weekday: 'long' }));

    $(".journey-date").change(function () {
        var ojd = $(this).closest(".search-form-date").find(".journey-date").val();
        const journeyDayName = new Date(ojd).toLocaleString('fa', { weekday: 'long' });
    ...
    $(".return-date").change(function () {
        ...
        const returnDayName = new Date(rd).toLocaleString('fa', { weekday: 'long' });
